<?php
	$suf_theme_definitions = array(
		...
		"light-theme-pale-blue" => array(
			...
			"h1.blogtitle a:hover/color" => "#227ad1",
		...
		"light-theme-gray-1" => array(
			...
			"h1.blogtitle a:hover/color" => "#787878",
		...
		"dark-theme-red" => array(
			...
			"h1.blogtitle a:hover/color" => "#8a1717",
		...
		"dark-theme-orange" => array(
			...
			"h1.blogtitle a:hover/color" => "#d05e0b",
		...
		"dark-theme-purple" => array(
			...
			"h1.blogtitle a:hover/color" => "#af0a4f",
...
<?php
	$suf_element_mapping = array(
		...
		"suf_blog_title_color" => "h1.blogtitle a/color",
		"suf_blog_title_style" => "h1.blogtitle a/text-decoration",
		"suf_blog_title_hover_color" => "h1.blogtitle a:hover/color",
		"suf_blog_title_hover_style" => "h1.blogtitle a:hover/text-decoration",
	...
	function suf_evaluate_style($style_name, $theme_name = "root") {
		global $suf_theme_definitions, $suf_element_mapping;
		if ($suf_element_mapping[$style_name] != null) {
			$mapped_style = $suf_element_mapping[$style_name];
			if ($suf_theme_definitions[$theme_name] != null) {
				$style_settings = $suf_theme_definitions[$theme_name];
				if ($style_settings[$mapped_style] != null) {
					...
					for ($i=0; $i<$counter; $i++) {
						$recursive = suf_evaluate_style($style_name, $ancestors[$i]);
						if ($recursive != null) {
							return $recursive;
						}
					}
